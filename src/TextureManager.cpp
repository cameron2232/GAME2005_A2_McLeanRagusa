...
void TextureManager::drawWithCustomSize(const std::string& id, const int x, const int y, const double angle, const int alpha, const int w, const int h, const bool centered, const SDL_RendererFlip flip)
{
	SDL_Rect srcRect;
	SDL_Rect destRect;
