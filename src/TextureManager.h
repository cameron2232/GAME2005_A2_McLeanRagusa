...
public:
	...
	void drawWithCustomSize(const std::string& id, int x, int y, double angle = 0, int alpha = 255, int w = 0, int h = 0, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
